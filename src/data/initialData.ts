...
export const INITIAL_SHOWCASE_SLOTS: ShowcaseVideoSlot[] = [
  ...
  },
  {
    ...
    tagline: 'Rafale Tactical Breakdown & Air Superiority',
    description:
      'In-depth strategic defence analysis and weapon kinetics breaking down Rafale multirole capabilities, radar envelopes, and frontline theatre deployment.',
    tags: ['Rafale Breakdown', '3D Kinetics', 'Radar Envelopes', 'Defence Strategy', 'Frontline Analysis'],
    aspectRatio: '9:16',
    duration: '0:40',
